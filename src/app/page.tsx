    ...
    <div className="flex flex-col">
      ...
      <section className="min-h-screen flex items-center pt-20 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-20 text-center">
          ...
          <p className="text-xl md:text-3xl text-white font-medium mb-12 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 px-4">
            <Link
              href="/contact"
              className="bg-white text-slate-900 px-10 py-5 rounded-full text-xl font-black shadow-2xl transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
            >
              Partner With Us <ArrowRight size={22} className="text-primary" />
            </Link>
            <Link
              href="/apply"
              className="bg-slate-900 text-white px-10 py-5 rounded-full text-xl font-black shadow-2xl transition-all hover:scale-105 active:scale-95 border border-white/10 text-center"
            >
              Join The Roster
            </Link>
          </div>
