      ...
      <section className="bg-slate-900 py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h1 className="text-6xl md:text-8xl font-serif text-white mb-8 leading-tight">
            Bring the Energy. <br />
            <span className="italic font-light opacity-90">Reap the Rewards.</span>
          </h1>
          <p className="text-xl md:text-3xl text-white/90 font-medium max-w-4xl mx-auto leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-24">
            {[
              ...
              <div key={idx} className="bg-slate-50 p-8 rounded-[3rem] border border-slate-100 hover:border-primary/20 transition-all group">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="relative">
              <div className="absolute -top-10 -right-10 opacity-10 w-[300px] h-[200px] pointer-events-none">
