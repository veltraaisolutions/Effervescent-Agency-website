  ...
  return (
    <section className="relative pt-24 md:pt-32 pb-0 overflow-hidden">
      ...
      <div className="relative w-full h-[450px] md:h-[650px] mt-20">
        {/* Left Image */}
        <div className="absolute bottom-0 left-0 w-[70%] md:w-[45%] h-full rounded-tr-[3.5rem] md:rounded-tr-[6rem] overflow-hidden shadow-3xl z-20 border-r border-white/10 group">
          <Image
        ...
        <div className="hidden md:block absolute bottom-12 md:bottom-20 md:left-[32%] w-[75%] md:w-[55%] h-[65%] md:h-[75%] rounded-[2rem] md:rounded-[4rem] overflow-hidden shadow-3xl transform rotate-[3deg] md:rotate-[6deg] border-4 border-white/20 z-10 group">
          <Image
